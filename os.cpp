...
{
      char process_name;
      int arrival_time, burst_time, ct, waiting_time, turnaroundtime, priority;
      int status;
}process_queue[10];
...
main()
{
      ...
      char c;
      float wait_time = 0, turnaroundtime = 0, average_waiting_time, average_turnaroundtime;
      ...
      for(time = process_queue[0].arrival_time; time < burst_time;)
      {
            ...
            process_queue[largest].turnaroundtime = process_queue[largest].ct - process_queue[largest].arrival_time;
            process_queue[largest].status = 1;
            wait_time = wait_time + process_queue[largest].waiting_time;
            turnaroundtime = turnaroundtime + process_queue[largest].turnaroundtime;
      ...
      average_turnaroundtime = turnaroundtime / limit;
